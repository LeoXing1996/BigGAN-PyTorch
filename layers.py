...
class SN(object):
    ...
    # Singular values;
    # note that these buffers are just for logging and are not used in training.  # noqa
    @property
    def sv(self):
    ...
    def W_(self):
        ...
        # Update the svs
        if self.training:
            # Make sure to do this in a no_grad()
            # context or you'll get memory leaks!
            with torch.no_grad():
